...
function init()
  ...
  softcut.event_render(on_render)
	...
	params:add{type = 'number', id = 'set_number_slices',name = 'Number of slices',min = 1,max = 64,default = 16, action = function(x) number_slices = x initialize_samples() slice_segments() end}
